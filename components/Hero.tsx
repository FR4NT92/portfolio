...
export default function Hero() {
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      {/* 1. TEXTOS (Ubicados y alineados exactamente como en tu imagen) */}
      ...
      {/* 2. BOTÓN (Abajo a la derecha, dos partes que se fusionan de forma líquida) */}
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <a 
          ...
          // El secreto de la fusión: el gap-3 (12px) pasa a gap-0 al hacer hover, atrayendo ambas partes.
